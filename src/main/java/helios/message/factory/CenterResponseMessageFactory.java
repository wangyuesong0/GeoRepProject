...
public class CenterResponseMessageFactory {
    ...
    public static CenterResponseMessage createCommitResponseMessage(String routingKey, long txnNum) {
        return new CenterResponseMessage(CenterMessageType.COMMIT, routingKey, txnNum);
    }
}
